...
export async function POST(request: Request) {
  ...
  const protectedCheck = assertBotProtectedForm('cms-login', formData)
  ...
  return NextResponse.json({ ok: true, message: 'Login CMS validado. Integrar con endpoint de Payload.' })
}
